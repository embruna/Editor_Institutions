...
DATAFILE$INST[DATAFILE$INST==  "humboldt university berlin"]<-"humboldt university of berlin"
  ...
  DATAFILE$INST[DATAFILE$INST== "macaulay institute" ]<-"macaulay land use research institute"
    ...
    # DATAFILE$INST[DATAFILE$INST==  ]<-
    # DATAFILE$INST[DATAFILE$INST==  ]<-
    DATAFILE$INST[DATAFILE$INST=="ulm"]<-"2x ulm"
    DATAFILE$INST[DATAFILE$INST=="ulster"]<-"2x ulster"
    DATAFILE$INST[DATAFILE$INST=="sydney"]<-"2x sydney"
    DATAFILE$INST[DATAFILE$INST=="syracuse"]<-"2x syracuse"
    DATAFILE$INST[DATAFILE$INST=="tartu"]<-"2x tartu"
    DATAFILE$INST[DATAFILE$INST=="tennessee"]<-"2x tennessee"
    DATAFILE$INST[DATAFILE$INST=="swansea"]<-"2x swansea"
    DATAFILE$INST[DATAFILE$INST=="seoul"]<-"2x seoul"
    DATAFILE$INST[DATAFILE$INST=="sackville"]<-"2x sackville"
    DATAFILE$INST[DATAFILE$INST=="salzburg"]<-"2x salzburg"
    DATAFILE$INST[DATAFILE$INST=="santiago"]<-"2x santiago"
    DATAFILE$INST[DATAFILE$INST=="queensland"]<-"2x queensland"
    DATAFILE$INST[DATAFILE$INST=="pretoria"]<-"2x pretoria"
    DATAFILE$INST[DATAFILE$INST=="peking"]<-"2x peking"
    DATAFILE$INST[DATAFILE$INST=="ohio"]<-"2x ohio"
    DATAFILE$INST[DATAFILE$INST=="north carolina"]<-"2x north carolina"
    DATAFILE$INST[DATAFILE$INST=="montpellier"]<-"2x montpellier"
    DATAFILE$INST[DATAFILE$INST=="monash"]<-"2x monash"
    DATAFILE$INST[DATAFILE$INST=="montana"]<-"2x montana"
    DATAFILE$INST[DATAFILE$INST=="madrid"]<-"2x madrid"
    DATAFILE$INST[DATAFILE$INST=="maine"]<-"2x maine"
    DATAFILE$INST[DATAFILE$INST=="massey"]<-"2x massey"
    DATAFILE$INST[DATAFILE$INST=="london"]<-"2x london"
    DATAFILE$INST[DATAFILE$INST=="krakow"]<-"2x krakow"
    DATAFILE$INST[DATAFILE$INST=="kyoto"]<-"2x kyoto"
    DATAFILE$INST[DATAFILE$INST=="jena"]<-"2x jena"
    DATAFILE$INST[DATAFILE$INST=="illinois"]<-"2x illinois"
    DATAFILE$INST[DATAFILE$INST=="indiana"]<-"2x indiana"
    DATAFILE$INST[DATAFILE$INST=="hokkaido"]<-"2x hokkaido"
    DATAFILE$INST[DATAFILE$INST=="guelph"]<-"2x guelph"
    DATAFILE$INST[DATAFILE$INST=="dundee"]<-"2x dundee"
    DATAFILE$INST[DATAFILE$INST=="dartmouth"]<-"2x dartmouth"
    DATAFILE$INST[DATAFILE$INST=="copenhagen"]<-"2x copenhagen"
    DATAFILE$INST[DATAFILE$INST=="cork"]<-"2x cork"
    DATAFILE$INST[DATAFILE$INST=="pennsylvania"]<-"2x pennsylvania"
    DATAFILE$INST[DATAFILE$INST=="philadelphia"]<-"2x philadelphia"
    DATAFILE$INST[DATAFILE$INST=="pittsburgh"]<-"2x pittsburgh"
    DATAFILE$INST[DATAFILE$INST=="reading"]<-"2x reading"
    DATAFILE$INST[DATAFILE$INST=="regina"]<-"2x regina"
    
    DATAFILE$INST[DATAFILE$INST=="saskatchewan"]<-"2x saskatchewan"
