...
DATAFILE$INST[DATAFILE$INST==  "humboldt university berlin"]<-"humboldt university of berlin"
  ...
  DATAFILE$INST[DATAFILE$INST== "macaulay institute" ]<-"macaulay land use research institute"
    ...
    DATAFILE$INST[DATAFILE$INST=="university of copenhagen"]<-"copenhagen university"
    ...
    DATAFILE$UNIT[DATAFILE$INST=="argonne national laboratory"]<-"doe argonne national laboratory"
    # DATAFILE$UNIT[DATAFILE$INST=="centro de ecologia"]<-"centro de ecologia"
    # DATAFILE$UNIT[DATAFILE$INST=="yale school of forestry and environmental studies"]<-"school of forestry and environmental studies"
    DATAFILE$UNIT[DATAFILE$INST=="washington university school of medicine"]<-"school of medicine"
    DATAFILE$NOTES[DATAFILE$INST=="us geological survey and university of miami"]<-"2x primary inst"
    DATAFILE$UNIT[DATAFILE$INST=="savannah river ecology laboratory"]<-"savannah river ecology laboratory"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="(retired) natural history museum london"]<-"retired"
    DATAFILE$INST[DATAFILE$LAST_NAME=="academy of sciences of russia"]<-"missing"
    DATAFILE$INST[DATAFILE$INST=="agricultural university wageningen"]<-"wageningen agricultural university"
    DATAFILE$INST[DATAFILE$LAST_NAME=="alberta"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="amsterdam"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="antwerp"]<-"missing"
    DATAFILE$COUNTRY[DATAFILE$INST=="arete associates"]<-"USA"
    DATAFILE$INST[DATAFILE$LAST_NAME=="arizona"]<-"missing"
    DATAFILE$UNIT[DATAFILE$LAST_NAME=="arnold arboretum of harvard university"]<-"arnold arboretum"
    DATAFILE$INST[DATAFILE$LAST_NAME=="arnold arboretum of harvard university"]<-"harvard university"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ascot"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="auckland"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="basf plant science"]<-"basf"
    DATAFILE$INST[DATAFILE$LAST_NAME=="beijing"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="bethesda"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="bialystok"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="bristol"]<-"missing"
    DATAFILE$COUNTRY[DATAFILE$INST=="british antarctic survey"]<-"United Kingdom"
    DATAFILE$INST[DATAFILE$LAST_NAME=="calyx, inc"]<-"calyx, inc"
    DATAFILE$INST[DATAFILE$LAST_NAME=="cardiff"]<-"missing"
    DATAFILE$COUNTRY[DATAFILE$INST=="carl von ossietzky university oldenburg"]<-"Germany"
    DATAFILE$INST[DATAFILE$LAST_NAME=="catholic university of chile"]<-"pontificia universidad catolica de chile"
    DATAFILE$UNIT[DATAFILE$INST=="center of marine sciences of algarve universidade"]<-"center of marine sciences"
    DATAFILE$INST[DATAFILE$INST=="center of marine sciences of algarve universidade"]<-"algarve universidade"
    DATAFILE$COUNTRY[DATAFILE$INST=="center of marine sciences of algarve universidade"]<-"Portugal"
    DATAFILE$INST[DATAFILE$LAST_NAME=="chicago"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="chris britton consultancy balfor beatty"]<-""
    DATAFILE$INST[DATAFILE$LAST_NAME=="christchurch"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="colorado"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="copenhagen"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="cork"]<-"missing"
    DATAFILE$INST[DATAFILE$INST=="csic institut mediterrani destudis avencats"]<-"Mediterranean Institute for Advanced Studies"
    DATAFILE$INST[DATAFILE$LAST_NAME=="csic institut mediterrani destudis avencats"]<-"Mediterranean Institute for Advanced Studies"
    DATAFILE$INST[DATAFILE$INST=="csic instituto de ciencias del mar"]<-"Mediterranean Institute for Advanced Studies"
    DATAFILE$INST[DATAFILE$LAST_NAME=="dartmouth"]<-"missing"
    DATAFILE$COUNTRY[DATAFILE$INST=="doe brookhaven national laboratory"]<-"USA"
    DATAFILE$COUNTRY[DATAFILE$INST=="doe brookhaven national laboratory"]<-"USA"
    DATAFILE$INST[DATAFILE$LAST_NAME=="dundee"]<-"missing"
    DATAFILE$INST[DATAFILE$INST=="environment canada wildlife research division"]<-"environment canada wildlife research east"
    DATAFILE$INST[DATAFILE$LAST_NAME=="evolutionary biology centre"]<-"university of uppsala"
    DATAFILE$COUNTRY[DATAFILE$INST=="florida dept of natural resources bureau of marine research"]<-"USA"
    DATAFILE$INST[DATAFILE$LAST_NAME=="forschungsinstitut senckenberg"]<-"senckenberg research institute"
    DATAFILE$INST[DATAFILE$LAST_NAME=="gorgan university of agric sci"]<-"gorgan university of agricultural sciences"
    DATAFILE$COUNTRY[DATAFILE$INST=="griffith university"]<-"Australia"
    DATAFILE$INST[DATAFILE$LAST_NAME=="guelph"]<-"missing"
    DATAFILE$COUNTRY[DATAFILE$INST=="haus nr9"]<-"Germany"
    DATAFILE$COUNTRY[DATAFILE$INST=="hebrew university of jerusalem"]<-"Israel"
    DATAFILE$INST[DATAFILE$LAST_NAME=="hokkaido"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$INST=="icbs ufal and oxford university"]<-"universidade federal de alagoas"
    DATAFILE$INST[DATAFILE$LAST_NAME=="illinois"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="indiana"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="institute of tropical forestry"]<-"international institute of tropical forestry"
    DATAFILE$INST[DATAFILE$LAST_NAME=="instituto de biociencias"]<-""
    DATAFILE$INST[DATAFILE$LAST_NAME=="instituto mediterraneo de estudios avanzados (imedea)"]<-"Mediterranean Institute for Advanced Studies"
    ...
    DATAFILE$INST[DATAFILE$INST=="istituto per l¢ambiente marino costiero"]<-"instituto per lambiente marino costiero"
    DATAFILE$INST[DATAFILE$LAST_NAME=="istituto per l¢ambiente marino costiero"]<-"instituto per lambiente marino costiero"
    DATAFILE$COUNTRY[DATAFILE$INST=="james cook university"]<-"Australia"
    DATAFILE$COUNTRY[DATAFILE$INST=="james cook university"]<-"Australia"
    DATAFILE$INST[DATAFILE$LAST_NAME=="jena"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="kings college"]<-"kings college london"
    DATAFILE$INST[DATAFILE$LAST_NAME=="krakow"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="kyoto"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="lancaster"]<-"lancaster university"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="lincoln university"]<-"university of lincoln"
    DATAFILE$INST[DATAFILE$LAST_NAME=="london"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ludwig maximilian universitat munchen"]<-"ludwig maximilian university of munich"
    DATAFILE$COUNTRY[DATAFILE$INST=="luminy universite d aix marseille"]<-"France"
    DATAFILE$INST[DATAFILE$LAST_NAME=="macaulay institute"]<-"macaulay land use research institute"
    DATAFILE$INST[DATAFILE$LAST_NAME=="madrid"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="maine"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="massey"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="Meggers"]<-"smithsonian national museum of natural history"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="monash"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="montana"]<-"missing"
    DATAFILE$COUNTRY[DATAFILE$INST=="monterey bay aquarium research institute"]<-"USA"
    DATAFILE$INST[DATAFILE$LAST_NAME=="montpellier"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="mpi jena"]<-"max planck institute for human history"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="national museum of natural history smithsonian institution"]<-"smithsonian national museum of natural history"
    DATAFILE$INST[DATAFILE$LAST_NAME=="national natural history museum paris"]<-"national museum of natural history france"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="nederlands institut voor onderzoek der zee"]<-"royal netherlands institute for sea research"
    DATAFILE$INST[DATAFILE$LAST_NAME=="nederlands institut voor onderzoek der zee"]<-"royal netherlands institute for sea research"
    DATAFILE$COUNTRY[DATAFILE$INST=="new york botanical garden"]<-"USA"
    DATAFILE$INST[DATAFILE$LAST_NAME=="newfoundland"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="nioo"]<-"netherlands institute of ecology"
    DATAFILE$NOTES[DATAFILE$LAST_NAME=="no one by this name"]<-"2x if on ed board this year"
    DATAFILE$INST[DATAFILE$LAST_NAME=="north carolina"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="northeast fisheries science center"]<-"noaa northeast fisheries science center"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ohio"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="oklahoma university"]<-"university of oklahoma"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="peking"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="pennsylvania"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="philadelphia"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="pittsburgh"]<-"missing"
    DATAFILE$INST[DATAFILE$INST=="prairie wildlife research center"]<-"usgs prairie wildlife research center"
    DATAFILE$INST[DATAFILE$LAST_NAME=="pretoria"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="queensland"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="reading"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="regina"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="retired (no affiliation)"]<-"retired"
    DATAFILE$COUNTRY[DATAFILE$INST=="rice university"]<-"USA"
    DATAFILE$INST[DATAFILE$LAST_NAME=="riso dtuniversity of national laboratory for sustainable energy"]<-"riso dtu national laboratory for sustainable energy"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="sackville"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="salzburg"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="santiago"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="sao paulo state university"]<-"universidade estadual paulista"
    DATAFILE$INST[DATAFILE$LAST_NAME=="saskatchewan"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="seattle wa"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="senckenberg research institute frankfurt"]<-"senckenberg research institute"
    DATAFILE$INST[DATAFILE$LAST_NAME=="seoul"]<-"missing"
    DATAFILE$INST[DATAFILE$INST=="smithsonian institution"]<-""
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="st de pytosociologie fondamental"]<-"centre regional de phytosociologie"
    DATAFILE$INST[DATAFILE$LAST_NAME=="state university of new york albany"]<-"suny albany"
    DATAFILE$INST[DATAFILE$LAST_NAME=="state university of new york binghamton"]<-"suny binghamton"
    DATAFILE$INST[DATAFILE$LAST_NAME=="state university of new york college of environmental science and forestry"]<-"suny college of environmental science and forestry"
    DATAFILE$INST[DATAFILE$LAST_NAME=="state university of new york state university of new york"]<-"suny state university of new york"
    DATAFILE$INST[DATAFILE$LAST_NAME=="state university of new york stony brook"]<-"suny stony brook"
    DATAFILE$INST[DATAFILE$LAST_NAME=="station detudes des gorilles et chimpanzes (segc)"]<-"station detudes des gorilles et chimpanzes"
    DATAFILE$INST[DATAFILE$LAST_NAME=="swansea"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="swedish agricultural university"]<-"swedish university of agricultural sciences"
    DATAFILE$INST[DATAFILE$LAST_NAME=="swiss federal institute wsl"]<-"swiss federal institute for forest snow and landscape research"
    DATAFILE$INST[DATAFILE$LAST_NAME=="sydney"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="syracuse"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="tartu"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="tennessee"]<-"missing"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="tulane"]<-"tulane university"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ufz center for environmental research"]<-"helmholtz centre for environmental research ufz"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ufz centre for environmental research leipzig halle"]<-"helmholtz centre for environmental research ufz leipzig halle"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ufz helmholtz ctr environm res"]<-"helmholtz centre for environmental research ufz"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ulm"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="ulster"]<-"missing"
    DATAFILE$INST[DATAFILE$LAST_NAME=="universidade federal do rio grande do norte (ufrn)"]<-"universidade federal do rio grande do norte"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="university of illinois university urbana champaign"]<-"university of illinois urbana champaign"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="university of university amsterdam"]<-"university of amsterdam"
    ...
    DATAFILE$INST[DATAFILE$LAST_NAME=="uppsala university"]<-"university of uppsala"
    DATAFILE$INST[DATAFILE$INST=="us arid land agricultural research center"]<-"usda arid land agricultural research center"
    DATAFILE$INST[DATAFILE$LAST_NAME=="us geological society"]<-"us geological survey"
    DATAFILE$INST[DATAFILE$INST=="virginia commonwealth u"]<-"virginia commonwealth university"
