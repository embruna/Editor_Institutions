...
# Brazil<-AnalysisData %>% filter(geo.code=="BRA")
# JEcol<-AnalysisData %>% filter(JOURNAL=="J Ecology")
# write.csv(JEcol, file="./Output/JECOL_EDS.csv", row.names = F) #export it as a csv file
